...
const table_title = ["Partner", "Registration Date", "Override"];
  ...
  return (
    <div className="my-team">
      <div className="my-team-header">
        ...
        />
        <Text className="caption H2 dark_1" text={"My Team"} />
      ...
      <div className="my-team-content">
        ...
        <div className="row">
          <div className="referals">
            <Text className={"H3 dark_1 caption"} text={"Referals"} />
