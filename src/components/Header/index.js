...
function Header({ toggleMenu, user, logout }) {
  ...
  return (
    <div className="header">
      <div className="header-left">
        <i
          className="fa fa-bars dark_2 bars"
        ...
        {profileShow && (
          <div className="header-right-profile">
            <div className="header-right-profile-content">
              <img
                src={process.env.REACT_APP_ASSETS_SERVER + user.filename}
                className="avatar"
                alt="___"
              />
              <div className="header-right-profile-content-letter">
                <Text className="H5 dark_1" text={user.username} />
                <Text className="P5 dark_2" text={user.email} />
              </div>
            </div>
