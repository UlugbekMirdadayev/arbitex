  ...
  return (
    <div className="announcements">
      <div className="announcements-header">
        ...
        />
        <Text className="caption H2 dark_1" text={"Announcements"} />
      </div>
      <div className="announcements-content">
        {data.map((item,index) => (
          <div key={index} className="item">
            <div className="row">
              <Text className={"H3 dark_1"} text={item.title} />
            </div>
            <div className="row">
              <Text className={"H6 dark_1"} text={"Announcement Date: "} />
              <Text className={"H6 dark_3"} text={item.date} />
            </div>
            <div className="row">
              <Text className={"H6 dark_1"} text={"Version: "} />
              <Text className={"H6 dark_3"} text={item.version} />
            </div>
            <div className="row">
              <Text className={"P4 dark_2"} text={item.content} />
            </div>
            <div className="row">
              <Text className={"P4 dark_1"} text={item.end} />
            </div>
          </div>
        ))}
      </div>
