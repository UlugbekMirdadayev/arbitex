...
import { termsOfService, investorAgreement } from "../../consts/index";
...
function Register({ error, user, loading, userRegisterRequest }) {
  ...
  }, [isConnected, userRegisterRequest, address]);
  ...
  return (
    <div className="register">
      <div className="register-left">
        <img src={arbImg} alt="arbImg" />
      </div>
      <div className="register-right">
        <div className="register-right-container">
          <Text className={"H1 dark_1"} text={"Create an account"} />
          <Text
            className={"sub-title P4 dark_3"}
            text={"Welcome to Arbitex.io"}
          />
          <Hr className={"first-hr"} />
          <Text className={"input-text H6 dark_1"} text={"Username"} />
          <Input
            icon={"fa fa-user"}
          ...
          /> */}
          <Text className={"input-text H6 dark_1"} text={"Password"} />
          <Input
            icon={"fa fa-lock"}
            icon2={"fa fa-eye"}
          ...
          <Button
            ...
            loading={loading}
          />
          <Text className={"H5 dark_1 text-but"} text={"or"} />
          <Button
            className={"register-btn space-x"}
            iconPos="metamask"
            icon={metamask}
        ...
        <div className="agree-modal">
          ...
          <div className="agree-modal-content">
            <div className="agree-modal-content-item">
              ...
              <div className="content">
                <Text className={"P3 dark_2 desc"} text={termsOfService} />
                <Hr />
              </div>
            </div>
            <div className="agree-modal-content-item">
          ...
          <div className="agree-modal-footer">
            <div className="agree-text">
              ...
              />
              <Text className={"dark_1 P3"} text={"Do you agree?"} />
            </div>
            {agree && (
              <Button
                className={`btn ${
                  agree ? "bg-main" : "bg-dark_3"
                } btn_lg dark_7`}
                text={"Confirm"}
                onClick={() => {
                  setOpen(false);
