  ...
  return (
    <div className="support">
      <div className="support-header">
        ...
        />
        <Text className="caption H2 dark_1" text={"Support"} />
      </div>
      <div className="support-content">
        ...
        <div className="discord-link">
          <Text className="H3 dark_1" text={"Discord link:"} />
          <Text className="H3 main" text={"discord.gg/arb@0000"} />
          <i
            className="fa fa-copy dark_2"
            onClick={() => {
              if (copyToClipboard(discordLink)) displayMsg("Copied");
            }}
          />
        </div>
      </div>
      <div className="support-footer">
        <Text className="H3 dark_1" text={"Privacy link:"} />
        <Text className="H3 main" text={"discord.gg/arb@0000"} />
        <i
          className="fa fa-copy dark_2"
          onClick={() => {
            if (copyToClipboard(privacyLink)) displayMsg("Copied");
          }}
        />
      </div>
    </div>
