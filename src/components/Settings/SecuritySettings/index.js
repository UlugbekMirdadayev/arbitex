...
import { getQRcode } from "../../../actions/accountAction";

import { setPassword } from "../../../actions/authAction";
import { displayMsg } from "../../../utils/toast";

function SecuritySettings({ user, qrcode, getQRcode, setPassword }) {
    ...
    <div className="security-settings">
      <div className="security-settings-col">
        <div className="container">
          <Text className={"H3 dark_1"} text={"Security Settings"} />
          <Text className={"H5 dark_1"} text={"Two Factor Authentication"} />
          <div className="letter-group">
            <Text className={"P4 dark_3"} text={"1. Insall "} />
            <Text className={"P4 secondary"} text={"Google Authenticator"} />
            <Text className={"P4 dark_3"} text={" on your mobile device."} />
          </div>
          <div className="letter-group">
            <Text className={"P4 dark_3"} text={"2. Your secret Code is: "} />
          </div>
          <div className="letter-group">
            <Text className={"P4 dark_1"} text={user.base32} />
          </div>
          <img src={qrcode.url} className={"qr-img"} alt="qr-img" />
          {/* <Text
            className={'P4 dark_3'}
      ...
      <div className="security-settings-col">
        <div className="container">
          <Text className={"H3 dark_1"} text={"Change Login Password"} />
          <Text className={"H5 dark_1"} text={"Current Password"} />
          ...
          <Text className={"H5 dark_1"} text={"New Password"} />
          ...
          <Text className={"H5 dark_1"} text={"Confirm Password"} />
