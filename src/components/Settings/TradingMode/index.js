...
function TradingMode({
  ...
  useEffect(() => {
    getAuteMode();
    getCompanyAccount();
  }, [user, getCompanyAccount, getAuteMode]);

  return (
    <div className="trading-mode">
      <Text className="H3 dark_1" text={"Trading Mode"} />
      <div className="trading-mode-list">
        <div className="trading-mode-item">
          <Card
            title={"Manual"}
            content={[
              "Choose this option if you would prefer to manually click the button to begin each profit cycle",
            ]}
            progress={0}
        ...
        <div className="trading-mode-item">
          <Card
            ...
            content={[
              autoMode
                ? "You have auto service by " + displayDate(_deadline)
          ...
          {confirm && (
            <div className="confirm-alert">
              <div className="content">You will pay 25$ for auto service.</div>
