...
import { getWeekDay } from "../../../actions/commonAction";
...
function WithdrawFunds({
  ...
  useEffect(() => {
    if (update) {
      if (withdrawFunds.message) displayMsg(withdrawFunds.message, "error");
      if (withdrawFunds.error) displayMsg(withdrawFunds.error, "error");
    }
  ...
  return (
    <div className="withdraw-funds">
      <Text className={"H3 dark_1"} text={"Withdraw Funds"} />
      <Text
      ...
      />
      <div className="item">
        <Text className={"cap H6 dark_1"} text={"Verify Token"} />
        <Input
          text={token}
      ...
      <div className="item">
        <Text className={"cap H6 dark_1"} text={"Amount to withdraw"} />
        <Input
          text={amount}
      ...
      <div className="item">
        <Text className={"cap H6 dark_1"} text={"Withdraw address"} />
        <Input
          text={address}
      ...
      <div className="item">
        <Text className={"cap H6 dark_1"} text={"Withdrawal fee"} />
        <Input
          text={fee}
      ...
      <Text
        ...
        text={
          "Make sure withdrawal address is correct. Funds can not be recovered if sent to wrong address "
        }
      />
      <Button
        ...
        <div className="withdraw-funds-modal">
          ...
          <div className="withdraw-funds-modal-content">
            ...
            <div className="to-address">
              ...
              <Text className={"P3 success"} text={address} />
            </div>
            <div className="verify-token">
              <Text className={"P3 dark_2"} text={"Verify Token: "} />
              <Text className={"P3 success"} text={token} />
            </div>
            <div className="amount">
              <Text className={"P3 dark_2"} text={"Amount"} />
              <Text className={"P3 success"} text={amount + " USDT"} />
            </div>
            <div className="fee">
              <Text className={"P3 dark_2"} text={"Commission: "} />
              <Text className={"P3 success"} text={fee + " USDT"} />
            </div>
            <div className="real-amount">
              <Text className={"P3 dark_2"} text={"You will get "} />
              <Text className={"P3 success"} text={realAmount + " USDT"} />
            </div>
            <Hr />
            <Button
