...
import { getDepositHistory } from "../../../actions/transactionAction";

function DepositHistory({ user, depositHistory, getDepositHistory }) {
  ...
  }, [user, getDepositHistory]);

  return (
    <div className="deposit-history">
      <Text className="H3 dark_1" text={"Deposit History"} />
      ...
      <div className="deposit-history-content">
        <div className="table-title">
          <div className="table-title-item">Date</div>
          <div className="table-title-item">Amount</div>
          <div className="table-title-item">Currency</div>
          <div className="table-title-item">Status</div>
          <div className="table-title-item">Tx</div>
          <div className="table-title-item">To</div>
        </div>
        <div className="table-content">
          {depositHistory.models.map((item, _index) => (
            <div key={_index} className="table-content-item">
              ...
              <div className="table-content-item-col">{item["currency"]}</div>
              <div className="table-content-item-col">
