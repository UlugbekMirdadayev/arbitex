...
import { createDepositFunds } from "../../../actions/transactionAction";
...
function DepositFunds({ user, depositFunds, createDepositFunds }) {
  ...
  const openTransactionWindow = () => {
    window.open(
      "https://etherscan.io/address/" + depositFunds.address,
      "_blank"
    );
  };
  ...
  return (
    <div className="deposit-funds">
      <Text className={"H3 dark_1"} text={"Deposit Funds"} />
      <div className="item">
        <Text className={"cap H6 dark_1"} text={"Amount to deposit"} />
        <Input
          text={amount}
      ...
      <Text
        ...
        text={
          "Please send a little bit more than desired amount to cover crypto prive flacturations."
        }
      />
      <Button
      ...
      <Modal open={open} onClose={() => setOpen(false)}>
        <div className="deposit-funds-modal">
          <div className="deposit-funds-modal-header">
            <Text className={"H4 dark_3"} text={"Result"} />
          </div>
          <div className="deposit-funds-modal-body">
            <i className="fa fa-check-circle success" />
            <Text className={"H3 dark_2"} text={successMsg} />
            <Text className={"P3 dark_2"} text={depositTitle} />
            <div className="qrcode">
              <img src={image} alt="___" />
            </div>
            <div className="address">
              <Text className={"P3 dark_2"} text={depositFunds.address} />
              <span onClick={copy}>
