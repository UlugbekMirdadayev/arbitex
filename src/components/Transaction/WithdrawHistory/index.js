...
import { getWithdrawHistory } from "../../../actions/transactionAction";
...
function WithdrawHistory({ user, withdrawHistory, getWithdrawHistory }) {
  ...
  }, [user, getWithdrawHistory]);

  return (
    <div className="withdraw-history">
      <Text className="H3 dark_1" text={"Withdrawal History"} />
      ...
      <div className="withdraw-history-content">
        ...
        <div className="table-content">
          {withdrawHistory.models.map((item, _index) => (
