...
function Login({ error, user, loading, userLogin }) {
    ...
    <div className="login">
      ...
      <div className="login-right">
        <div className="login-right-container">
          <Text className={"H1 dark_1"} text={"Login to account"} />
          <Text
            className={"sub-title P4 dark_3"}
            text={"Welcome to Arbitex.io"}
          />
          <Hr className={"first-hr"} />
          <Text className={"input-text H6 dark_1"} text={"Email"} />
          <Input
            icon={"fa fa-envelope"}
            placeholder={"Email"}
            text={email}
          ...
          >
            <Text className={"H6 dark_1"} text={"Password"} />
            {/* <Text
              className={'P5 info'}
